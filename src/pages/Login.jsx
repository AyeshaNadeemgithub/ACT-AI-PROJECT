...
const roles = [
  { id: "patient", emoji: "", label: "Patient", subtitle: "Continue your wellness journey", color: "#7C3AED", bg: "#F5F3FF", border: "#C4B5FD" },
  { id: "psychologist", emoji: "", label: "Psychologist", subtitle: "Manage your patients", color: "#0E7490", bg: "#ECFEFF", border: "#A5F3FC" },
      ...
      <div className="login-card" style={styles.card}>
        ...
        {step === "role" && (
          <div style={styles.fadeIn}>
            <h1 className="login-heading" style={styles.heading}>Welcome back.</h1>
        ...
        {step === "login" && roleObj && (
          <div style={styles.fadeIn}>
            ...
            <h1 className="login-heading" style={{ ...styles.heading, fontSize: 32, marginTop: 12 }}>Sign in</h1>
...
const styles = {
  ...
  eyeBtn: { position: "absolute", right: 14, background: "none", fontSize: 11, fontWeight: 800, color: "#7C3AED", cursor: "pointer", padding: "4px 8px", textTransform: "uppercase", letterSpacing: "0.05em" },

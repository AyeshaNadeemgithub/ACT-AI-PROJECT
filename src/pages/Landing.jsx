    ...
    <>
      <nav className="landing-nav" style={{
        ...
        <button
          ...
          style={{
            ...
            fontSize: 26, cursor: "pointer", color: colors.text,
      ...
      {mobileMenuOpen && (
        <div className="landing-mobile-menu" style={{
          ...
          <a href="#features" onClick={() => { setActiveTab("features"); setMobileMenuOpen(false); }} style={{ ...navLinkStyle("features"), fontSize: 16, padding: "8px 0" }}>Features</a>
          <a href="#therapists" onClick={() => { setActiveTab("therapists"); setMobileMenuOpen(false); }} style={{ ...navLinkStyle("therapists"), fontSize: 16, padding: "8px 0" }}>Therapists</a>
          <div style={{ display: "flex", gap: 12, marginTop: 8 }}>
            <Button onClick={() => { navigate("/login"); setMobileMenuOpen(false); }} variant="ghost" size="md" fullWidth>Login</Button>
            <Button onClick={() => { navigate("/patient-signup"); setMobileMenuOpen(false); }} size="md" fullWidth className="glow-pulse">Sign Up</Button>
          </div>
        </div>
      )}
    </>
...
const Hero = () => {
  ...
  return (
    <section style={{
      ...
      <FloatingSparkles />
      <div className="landing-hero-content" style={{ position: "relative", zIndex: 2, padding: "64px 80px", maxWidth: 560 }}>
  ...
  return (
    <section id="features" className="mobile-section-padding" style={{ padding: "100px 80px", background: colors.bg }}>
      <div ref={revealRef} style={{ textAlign: "center", marginBottom: 64 }} className="reveal-on-scroll">
        ...
        <h2 className="landing-section-title" style={{ fontFamily: fonts.display, fontSize: 48, fontWeight: 700, color: colors.text, letterSpacing: "-0.03em", lineHeight: 1.1 }}>
    ...
    <section className="mobile-section-padding" style={{ padding: "100px 80px", background: "#fff" }}>
      <div ref={revealRef} className="reveal-on-scroll mobile-section-padding" style={{
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          <h2 className="landing-cta-title" style={{ fontFamily: fonts.display, fontSize: 52, fontWeight: 700, color: colors.text, marginBottom: 20, lineHeight: 1.1 }}>
...
// ─── Footer ───────────────────────────────────────────────────────────────────
const Footer = () => (
  <footer className="landing-footer" style={{ background: "#1E1B4B", color: "#fff", padding: "64px 80px 32px" }}>
    <div className="landing-footer-top" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 48, flexWrap: "wrap", gap: 32 }}>
